# This is a Class for a jokbo(value table of a seotda game)
class Jokbo:
    # constructor for a Jokbo instance
    def __init__(self) -> None:
        # member variable for saving a jokbo name
    ...
    # member function for creating a jokbo
